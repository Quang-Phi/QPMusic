            ...
            <div class="card plan__info overflow-hidden">
                <div class="card-body d-flex flex-column p-0">
                    <div class="p-4">
                        ...
                        <b class="capitalize mt-2">Normal</b> package subscription will be cancelled. <br>
                        <br>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input name="gender" disabled type="text" id="Gender" class="form-control"
                                    value="{{ old('gender', $user->gender == 1 ? 'Male' : 'Female') }}" />
                            </div>
                            <div class="col-sm-6">
                            ...
                            <div class="col-12">
                                <a class="btn btn-primary" href="{{ route('user.profile.edit') }}">Edit Profile</a>
                            </div>
                        </div>
                    </div>
                </form>
