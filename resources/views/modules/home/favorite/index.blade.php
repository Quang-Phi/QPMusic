    ...
    <div class="section">
        <div class="section__head">
            <div class="flex-grow-1">
                <span class="section__subtitle">your choice</span>
                <h3 class="mb-0">
                    Favorite <span class="text-primary">Artist</span>
                </h3>
            </div>
        </div>
        <div class="swiper-carousel swiper-carousel-button">
            <div class="swiper" data-swiper-slides="6" data-swiper-autoplay="true">
                <div class="swiper-wrapper">
                    @if ($artists->isEmpty())
                    <p class="empty"> The favorite Artists list is empty.</p>
                    @else
    ...
    <div class="section">
        <div class="section__head capitalize">
            <div class="flex-grow-1">
                <span class="section__subtitle">your choice</span>
                <h3 class="mb-0">
                    Favorite <span class="text-primary">Song</span>
                </h3>
            </div>
        </div>
        <div style="display: grid;grid-template-columns: repeat(2, 1fr);column-gap: 20px;row-gap: 0px;"
            class="list song-favorite list-favorite-songs">
            ...
            <div class="list__item" data-song-id="{{ $song['song']->id }}" data-song-name="{{ $song['song']->name }}"
                data-song-artist="{{ $song['song']->artist_name }}" data-song-album=""
                data-song-url="{{ asset('music/' . $song['song']->url) }}" data-song-cover="{{ $img }}">
                ...
                <ul class="list__option">
                    <li class="relative_time">{{ $song['relative_time'] }}</li>
                    <li class="icon-fvr">
                    ...
                    <li class="dropstart d-inline-flex">
                        <a class="dropdown-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown"
                            ...
                            <ul class="dropdown-menu dropdown-menu-sm">
                                ...
                                <li>
                                    <a class="dropdown-item" href="javascript:void(0);" role="button"
                                        data-queue-id="{{ $song['song']->id }}">Add to queue</a>
                                </li>
                                ...
                                <li class="item-download">
                                    <a class="dropdown-item" href="javascript:void(0);" role="button"
                                        data-download-id="{{ $song['song']->id }}">Download</a>
                                </li>
                                <li>
        ...
        <div class="mt-5 text-center">
            <a href="javascript:void(0);" data-type="favorite" data-limit="20" data-quantity="20"
    ...
    <div class="section">
        <div class="section__head">
            <div class="flex-grow-1">
                <span class="section__subtitle">your choice</span>
                <h3 class="mb-0">
                    Favorite <span class="text-primary">Album</span>
                </h3>
            </div>
        </div>
        <div class="swiper-carousel swiper-carousel-button album-wraper">
            <div class="swiper" data-swiper-slides="5" data-swiper-autoplay="true">
                <div class="swiper-wrapper">
                    ...
                    $favorite = App\Models\Favorite::where('album_id', $album['album']->id)->where('user_id',$user ->id)->first();
                    @endphp
                            ...
                            <div class="cover__head">
                                ...
                                <div class="cover__options dropstart d-inline-flex ms-auto"><a class="dropdown-link"
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-sm">
                                        <li>
                                            <a class="dropdown-item" href="javascript:void(0);" role="button"
                                            data-collection-play-id="{{ $album['album']->id }}" 
                                            data-type="album" 
