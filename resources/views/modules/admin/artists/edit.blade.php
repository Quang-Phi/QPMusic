    ...
    <section class="wrapper main-wrapper" style=''>
        <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
            <div class="page-title">
                ...
                <div class="pull-left">
                    <h1 class="title">Edit a Artist</h1>
                </div>
        ...
        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
            <section class="box ">
                ...
                <div class="content-body">
                    <div class="row">
                        <form action="{{ route('admin.artists.update', ['id' => $artist->id]) }}" method="POST"
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-10 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="name" value="{{ old('title', $artist->name) }}"
                                ...
                                <div class="form-group">
                                    <label class="form-label" for="field-2">Biography</label>
                                    <span class="desc"></span>
                                    <div class="controls">
                                        <textarea name="" id="" style="width:100%;" rows="3">{{ old('title', $artist->bio) }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    @php
                                        $img = $artist->img_url == null || !file_exists(public_path('img/artist/' . $artist->img_url)) ? $artist->img_url : asset('img/artist/' . $artist->img_url);
                                    @endphp
                                    <label class="form-label" for="field-3">Avatar *</label>
                                    <span class="desc"></span>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-10 col-xs-12 padding-bottom-30">
                                <div class="text-right">
                                    ...
                                    <a href="/admin/artists/all" class="btn btn-primary btn-submit ms-2">Cancel</a>                                </div>
                            </div>
                        </form>
                    </div>
