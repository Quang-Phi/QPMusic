                                        ...
                                        <div class="group-choose"
                                            ...
                                            <div class="group-artist">
                                                <div class="title artist-title justify-content-between d-flex">
                                                    <div class="search-artist"><input type="search" name="" id="artist">
                                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <textarea style="width:100%;" class="@error('description') is-invalid @enderror"
                                        name="description" id="" rows="5">{{ old('description') }}</textarea>
                                    @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group img">
                                ...
                                <div class="controls upload-img">
                                    ...
                                    <label for="upload-img-input" class="drop-container">
                                        <input id="img" name="img_url" type="file" dropzone="true" accept="image/*"
